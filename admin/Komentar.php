...
class Komentar extends CI_Controller{
    ...
    // method untuk mengubah status komentar menjadi publish
    function publish(){
        // mengambil id komentar dari segment url
        $kode = htmlspecialchars($this->uri->segment(4),ENT_QUOTES);
        // query untuk update status komentar menjadi 1 (publish)
    ...
    function reply(){
        ...
        // menyiapkan data untuk masuk ke dalam database
        $data = array(
            'komentar_nama' 			=> $nama,
            'komentar_email' 			=> '',

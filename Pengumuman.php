<?php
// controller ini bertanggung jawab untuk menampilkan halaman pengumuman 
...
class Pengumuman extends CI_Controller{
	...
	// method untuk menampilkan halaman pengumuman
	function index(){
		// memanggil method pengumuman dan disimpan di variabel $jum
        ...
        if(!$page):
            $offset = 0;
			// jika variabel $page memiliki nilai maka satu halaman menampilkan 7 pengumuman per halaman
        else:
            $offset = $page;
        endif;
        $limit=7;
		// konfigurasi untuk URL dasar dari halaman
